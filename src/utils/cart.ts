 ...
 * @returns 총 할인금액
 */
export const calculateTotalDiscount = (items: CartItem[]): number =>
 ...
 * @returns 총 상품금액
 */
export const calculateFinalAmount = (items: CartItem[]): number =>
 ...
 * @returns 배송비
 */
export const calculateDeliveryFee = (items: CartItem[]): number =>
